export default {
  ...
  footer: (<div className="my-24  border-t-2  mx-auto flex items-center sm:flex-row flex-col">
      <p className="text-sm text-gray-500">© By Nacho Tineo  —
        <a href="https://nextra.site/" className="text-gray-600" rel="noopener noreferrer" target="_blank"> Built with Nextra</a>
      </p>
  ...
  //                 </div>
  //                 <div>
  //                     <button type="submit" className="py-3 px-5 w-full text-sm font-medium text-center text-black rounded-lg border cursor-pointer bg-primary-700 border-primary-600 sm:rounded-none sm:rounded-r-lg hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:text-white dark:hover:bg-primary-700 dark:focus:ring-primary-800">Subscribe</button>
  //                 </div>
  //             </div>
